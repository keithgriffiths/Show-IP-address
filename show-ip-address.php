 ...
 * Plugin URI: https://www.keith-griffiths.com
 ...
 * Author URI: https://www.keith-griffiths.com
 * Licence: GPLv2
 */
...
function ip_address_display_settings(){
        ...
        echo '<h1>Show IP Address Information</h1> <div>A simple plugin to show your IP address information on any of your pages, posts or widgets. <br>Shows your IP address on your dashboard from any location.</div> <hr> <div>The idea is simple, give it a go, let us know what you think of this plugin. Any suggested updates <br> I\'ll consider in each build <a href="http://www.keith-griffiths.com/contact-me">click here</a> to contact me anytime.</div>';
        ...
        echo '<br><br><br><br>Thank you for using my plugin - Show IP address V.1.3 - Last Updated: 2015-7-28';
