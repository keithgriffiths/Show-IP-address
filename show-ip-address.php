...
/* Copyright 2015 - 2022 Keith Griffiths (email : info@keith-griffiths.com)
...
function ip_address_display_settings(){
        ...
        echo '<h1>Show IP Address Information</h1> <div>A simple plugin to show your IP address information on any of your pages, posts or widgets. <br>Shows your IP address on your dashboard from any location.</div> <hr> <div>The idea is simple, give it a go, let me know what you think of this plugin. Any suggested updates <br> I\'ll consider in each build <a href="https://www.keithgriffiths.co.uk/">click here</a> to contact me anytime.</div>';
		...
		echo '<strong>Q)</strong>. What\'s the point in showing a person there IP address? <br> <strong>A)</strong>. You may want to create a secure page on your website and show the user their IP address.<hr>';

        echo '<br><br><br><br>Thank you for using my plugin - Show IP address V.1.6 - Last Updated: 09-11-2022';
...
if(is_admin())

	{
...

		{
			...
			echo '<div class="box-ip"><hr> Your IP address is something you might rarely think about, it\'s important to know what your IP address is and when it changes. Your IP address is used to identify computers on the Internet. <hr> Want to know more about IP addresses, or to get the ltest updates on this plugin, go to the "Show IP Info" using the menu on the left side. <hr>Show IP address. Latest version 1.6</div>';
